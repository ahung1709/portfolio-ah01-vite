...
export const projectsData = [
  {
    ...
    description: `A full-stack MERN application for a physiotherapy clinic, featuring a public website and a custom CMS for managing content. Visitors can browse services, team information, blog posts, and contact pages, while administrators can securely update content through an intuitive dashboard.

Built with React, Node.js, Express, and MongoDB, the app includes JWT authentication, RESTful APIs, and Cloudinary image uploads. This project demonstrates full-stack development, CMS design, and integration of third-party services in a production-ready application.`,
    tech: {
      frontend: [
        "React",
        "React Router DOM",
      ...
      cloud: ["MongoDB Atlas", "Heroku"],
      services: ["Cloudinary", "EmailJS"],
    },
    github: [
      {
        label: "Code",
